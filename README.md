## sophus_ros_toolkit (kinetic) - 0.1.3-0

The packages in the `sophus_ros_toolkit` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --track kinetic --rosdistro kinetic sophus_ros_toolkit` on `Sun, 04 Sep 2016 10:53:01 -0000`
...
## sophus_ros_toolkit (indigo) - 0.1.3-0
